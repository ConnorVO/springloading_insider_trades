...
from settings import SEC_API_DATETIME_FORMAT
...
def get_filings(start_date_string: str, end_date_string: str):
    ...
    xml_urls = [
        (
            ...
            get_xml_url(x["linkToFilingDetails"]),
        )
    ...
    for url in [
        ...
        try:
            edgar_res = fetch_edgar_data(url[1])
        ...
        form4_filings.append(scrape_form4filing_from_xml(filing_text, url[0]))
